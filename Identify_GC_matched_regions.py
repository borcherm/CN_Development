...
def get_args():
  ...
  parser.add_argument("-rbed", help="A bed file with coordinates for the feature being matched to. The gc matching will avoid these bins for normalization")
  parser.add_argument("-assembly", help= "A fasta for the genome assembly to pull gc matched bins from")
  parser.add_argument("-roi", help = "A fasta file for the region you wish to gc match to")
