...
def get_args():
  ...
  parser.add_argument("-whole_gene", help = "An unspliced gene fasta to compare kmers from a spliced CDS to", required=True)
...
with open("config.yml","a+") as fil:
    ...
    fil.write("WHOLE_GENE:"+ "\n")
    fil.write("  - \"" + str(whole_gene) + "\"" +"\n")
